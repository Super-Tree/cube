...
class kitti_mv3d(datasets.imdb):
    ...
    def image_path_from_index(self, index):
        ...
        image_path = os.path.join(self._data_path, prefix, str(index) + self._image_ext)
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(datasets.ROOT_DIR, 'data', 'KITTI_ORIGIN')
    ...
    def _load_kitti_calib(self, index):
        ...
        calib_dir = os.path.join(self._data_path, prefix, str(index).zfill(6) + '.txt')
...
#         P0 = np.array(obj, dtype=np.float32)
    ...
    def _load_kitti_annotation(self, index):
        ...
        filename = os.path.join(self._data_path, 'training/label_2', str(index).zfill(6) + '.txt')
